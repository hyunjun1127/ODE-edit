...
> 이 문서는 immutable v1 상세 분석의 successor다. v1 raw/표/보고서는 수정하지 않았으며, Official baseline 이름을 풀어 쓰고 W0-only canonical CounterFact NS backfill을 추가했다.
...
- PRE_EDIT/W0 canonical NS는 새 observation-only TECH-R2 job `36275_[0-1]`에서 기록했다: Llama `893/1000 (89.30%)`, Qwen `849/1000 (84.90%)`.
- 기존 v1 표의 `NS`는 canonical NS가 아니었다. 그것은 PRE_EDIT 대비 target-true token prediction preservation이며 이 문서에서는 `PP-token`으로 교정한다.
- `1010`은 오류 난 prompt 분모가 아니라 token 분모다. 1,000 locality prompt 중 990개는 target-true 1-token, case `9936`(request ordinal 61)의 10개 prompt는 2-token이라 `990×1 + 10×2 = 1010`이다.
- prompt 단위 all-token prediction preservation은 `PP-prompt`로 따로 산출했으며 분모가 정확히 `1000`이다.
- 원 round0 endpoint에는 `locality_target_new` NLL이 없으므로 endpoint canonical NS는 `NOT_RECORDED_SCHEMA_GAP`; PP나 target-true accuracy로 대체·추정하지 않았다.
- PRE_EDIT backfill은 model load/evaluator 외 editor, compute_z, key, solve, writer, model update, cache/history mutation이 모두 0이고 W0 pointer/version/bytes가 동일하다.
- 결론은 서술적 사실이며 `scientific_promotion=false`; remaining-nine 제출은 0이다.

## 1. 지표 정의와 분모

| metric | unit | denominator | definition | availability |
| --- | --- | --- | --- | --- |
| canonical_ns | locality_prompt_pair | 1000 | target_true_nll < target_new_nll; ties fail | PRE_EDIT_RECORDED; ENDPOINT_NOT_RECORDED_SCHEMA_GAP |
| pp_prompt | locality_prompt | 1000 | all target-true token predictions equal PRE_EDIT for a prompt | ENDPOINT_RECORDED; PRE_EDIT_NOT_APPLICABLE |
| pp_token | target_true_token | 1010 | individual target-true token predictions equal PRE_EDIT | ENDPOINT_RECORDED; 990x1-token + 10x2-token prompts |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| llama3-8b-inst | PRE_EDIT (W0 common) | ENTRY_REFERENCE | 13/100 (13.00%) | 28/200 (14.00%) | 8/100 (8.00%) | 893/1000 (89.30%) | N/A | N/A |
| llama3-8b-inst | Official MEMIT | TERMINAL_VALID | 98/100 (98.00%) | 164/200 (82.00%) | 77/100 (77.00%) | NOT_RECORDED_SCHEMA_GAP | 941/1000 (94.10%) | 951/1010 (94.16%) |
| llama3-8b-inst | MEMIT+QCL | HORIZON_SEMANTIC_MISS | 96/100 (96.00%) | 156/200 (78.00%) | 69/100 (69.00%) | NOT_RECORDED_SCHEMA_GAP | 942/1000 (94.20%) | 952/1010 (94.26%) |
| llama3-8b-inst | MEMIT+NQFIX | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 183/200 (91.50%) | 87/100 (87.00%) | NOT_RECORDED_SCHEMA_GAP | 931/1000 (93.10%) | 941/1010 (93.17%) |
| llama3-8b-inst | MEMIT+ORBFH | HORIZON_SEMANTIC_MISS | 98/100 (98.00%) | 162/200 (81.00%) | 75/100 (75.00%) | NOT_RECORDED_SCHEMA_GAP | 930/1000 (93.00%) | 940/1010 (93.07%) |
| llama3-8b-inst | MEMIT+JAC | HORIZON_SEMANTIC_MISS | 98/100 (98.00%) | 163/200 (81.50%) | 76/100 (76.00%) | NOT_RECORDED_SCHEMA_GAP | 926/1000 (92.60%) | 936/1010 (92.67%) |
| llama3-8b-inst | Official AlphaEdit | TERMINAL_VALID | 100/100 (100.00%) | 184/200 (92.00%) | 89/100 (89.00%) | NOT_RECORDED_SCHEMA_GAP | 867/1000 (86.70%) | 877/1010 (86.83%) |
| llama3-8b-inst | AlphaEdit+QCL | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 169/200 (84.50%) | 79/100 (79.00%) | NOT_RECORDED_SCHEMA_GAP | 881/1000 (88.10%) | 891/1010 (88.22%) |
| llama3-8b-inst | AlphaEdit+NQFIX | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 190/200 (95.00%) | 93/100 (93.00%) | NOT_RECORDED_SCHEMA_GAP | 858/1000 (85.80%) | 868/1010 (85.94%) |
| llama3-8b-inst | AlphaEdit+ORBFH | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 168/200 (84.00%) | 79/100 (79.00%) | NOT_RECORDED_SCHEMA_GAP | 880/1000 (88.00%) | 890/1010 (88.12%) |
| llama3-8b-inst | AlphaEdit+JAC | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 169/200 (84.50%) | 79/100 (79.00%) | NOT_RECORDED_SCHEMA_GAP | 878/1000 (87.80%) | 888/1010 (87.92%) |
| qwen2.5-7b-inst | PRE_EDIT (W0 common) | ENTRY_REFERENCE | 11/100 (11.00%) | 39/200 (19.50%) | 10/100 (10.00%) | 849/1000 (84.90%) | N/A | N/A |
| qwen2.5-7b-inst | Official MEMIT | TERMINAL_VALID | 100/100 (100.00%) | 192/200 (96.00%) | 95/100 (95.00%) | NOT_RECORDED_SCHEMA_GAP | 888/1000 (88.80%) | 898/1010 (88.91%) |
| qwen2.5-7b-inst | MEMIT+QCL | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 189/200 (94.50%) | 93/100 (93.00%) | NOT_RECORDED_SCHEMA_GAP | 895/1000 (89.50%) | 905/1010 (89.60%) |
| qwen2.5-7b-inst | MEMIT+NQFIX | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 189/200 (94.50%) | 93/100 (93.00%) | NOT_RECORDED_SCHEMA_GAP | 847/1000 (84.70%) | 857/1010 (84.85%) |
| qwen2.5-7b-inst | MEMIT+ORBFH | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 190/200 (95.00%) | 94/100 (94.00%) | NOT_RECORDED_SCHEMA_GAP | 879/1000 (87.90%) | 889/1010 (88.02%) |
| qwen2.5-7b-inst | MEMIT+JAC | HORIZON_SEMANTIC_MISS | 99/100 (99.00%) | 190/200 (95.00%) | 94/100 (94.00%) | NOT_RECORDED_SCHEMA_GAP | 865/1000 (86.50%) | 875/1010 (86.63%) |
| qwen2.5-7b-inst | Official AlphaEdit | TERMINAL_VALID | 100/100 (100.00%) | 191/200 (95.50%) | 94/100 (94.00%) | NOT_RECORDED_SCHEMA_GAP | 856/1000 (85.60%) | 866/1010 (85.74%) |
| qwen2.5-7b-inst | AlphaEdit+QCL | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 191/200 (95.50%) | 94/100 (94.00%) | NOT_RECORDED_SCHEMA_GAP | 879/1000 (87.90%) | 889/1010 (88.02%) |
| qwen2.5-7b-inst | AlphaEdit+NQFIX | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 190/200 (95.00%) | 94/100 (94.00%) | NOT_RECORDED_SCHEMA_GAP | 828/1000 (82.80%) | 838/1010 (82.97%) |
| qwen2.5-7b-inst | AlphaEdit+ORBFH | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 191/200 (95.50%) | 94/100 (94.00%) | NOT_RECORDED_SCHEMA_GAP | 871/1000 (87.10%) | 881/1010 (87.23%) |
| qwen2.5-7b-inst | AlphaEdit+JAC | HORIZON_SEMANTIC_MISS | 100/100 (100.00%) | 190/200 (95.00%) | 94/100 (94.00%) | NOT_RECORDED_SCHEMA_GAP | 867/1000 (86.70%) | 877/1010 (86.83%) |

`HORIZON_SEMANTIC_MISS`는 100/100 동시 strict global prefix가 없었다는 과학 관측이다. endpoint 자체는 terminal-valid하며 낮은 성능이나 Official 차이를 기술 실패로 재분류하지 않았다.

### 2.1 Secondary target-token accuracy

| model | method | RW new | RW true | RP new | RP true | LOC true |
| --- | --- | --- | --- | --- | --- | --- |
| llama3-8b-inst | PRE_EDIT (W0 common) | 0.00% | 19.00% | 0.50% | 18.00% | 20.80% |
| llama3-8b-inst | Official MEMIT | 95.00% | 1.00% | 48.50% | 3.50% | 20.50% |
| llama3-8b-inst | MEMIT+QCL | 89.00% | 1.00% | 44.00% | 4.00% | 20.60% |
| llama3-8b-inst | MEMIT+NQFIX | 100.00% | 0.00% | 57.00% | 3.00% | 20.20% |
| llama3-8b-inst | MEMIT+ORBFH | 96.00% | 1.00% | 48.50% | 4.00% | 20.50% |
| llama3-8b-inst | MEMIT+JAC | 96.00% | 1.00% | 48.00% | 4.00% | 20.40% |
| llama3-8b-inst | Official AlphaEdit | 100.00% | 0.00% | 60.00% | 3.50% | 21.00% |
| llama3-8b-inst | AlphaEdit+QCL | 99.00% | 0.00% | 54.00% | 3.50% | 20.60% |
| llama3-8b-inst | AlphaEdit+NQFIX | 100.00% | 0.00% | 63.00% | 3.00% | 20.90% |
| llama3-8b-inst | AlphaEdit+ORBFH | 99.00% | 0.00% | 53.50% | 3.50% | 20.60% |
| llama3-8b-inst | AlphaEdit+JAC | 100.00% | 0.00% | 53.50% | 3.50% | 20.80% |
| qwen2.5-7b-inst | PRE_EDIT (W0 common) | 0.00% | 13.00% | 0.50% | 16.00% | 15.30% |
| qwen2.5-7b-inst | Official MEMIT | 100.00% | 0.00% | 65.00% | 1.00% | 14.60% |
| qwen2.5-7b-inst | MEMIT+QCL | 99.00% | 0.00% | 65.00% | 1.00% | 15.00% |
| qwen2.5-7b-inst | MEMIT+NQFIX | 100.00% | 0.00% | 66.00% | 1.00% | 12.70% |
| qwen2.5-7b-inst | MEMIT+ORBFH | 100.00% | 0.00% | 66.50% | 1.00% | 14.10% |
| qwen2.5-7b-inst | MEMIT+JAC | 98.00% | 0.00% | 65.50% | 1.00% | 14.10% |
| qwen2.5-7b-inst | Official AlphaEdit | 99.00% | 0.00% | 66.00% | 1.00% | 13.60% |
| qwen2.5-7b-inst | AlphaEdit+QCL | 99.00% | 0.00% | 65.00% | 1.00% | 15.00% |
| qwen2.5-7b-inst | AlphaEdit+NQFIX | 99.00% | 0.00% | 66.50% | 1.00% | 12.40% |
| qwen2.5-7b-inst | AlphaEdit+ORBFH | 99.00% | 0.00% | 67.00% | 1.00% | 14.20% |
| qwen2.5-7b-inst | AlphaEdit+JAC | 100.00% | 0.00% | 66.00% | 1.00% | 14.40% |

## 3. PRE_EDIT/W0 canonical NS backfill

| model | scheduler | canonical NS | ties | row identity root | summary identity |
| --- | --- | --- | --- | --- | --- |
| llama3-8b-inst | 36275_0→36276 | 893/1000 (89.30%) | 0 | 9a516fcbda83da59bfebac23fd4d0d43dc950703d67964054e816c4d41329422 | eb9ad0d89b40b4f11947cb1b9098bd10b8c6715e4207da7d7f63ad2c1f606ce1 |
| qwen2.5-7b-inst | 36275_1→36275 | 849/1000 (84.90%) | 0 | 29cf4287fd5fecc9d61789552c0adf3bae571d6242b49e582bc4175c09a16899 | 09705c164bfd60f2b73aeee917c28c2fd444994f6d749d2768491611c2a071b9 |

TECH-R1 `36273_[0-1]`은 sealed request row에 존재하지 않는 `round_ordinal` 필드를 읽은 `KeyError` 기술 실패라 분모 0으로 보존했다. science/threshold/tolerance 변경 없이 ordinal을 sealed list 순서로 bind한 TECH-R2만 canonical backfill이다.

### 3.1 PRE_EDIT rewrite/rephrase/locality NLL 전체 분포

| model | prompt | quantity | n | mean | median | p90 | max |
| --- | --- | --- | --- | --- | --- | --- | --- |
| llama3-8b-inst | rewrite | target_new_nll | 100 | 11.102701 | 10.909377 | 16.596692 | 20.853899 |
| llama3-8b-inst | rewrite | target_true_nll | 100 | 4.942957 | 4.157356 | 10.377397 | 15.270686 |
| llama3-8b-inst | rephrase | target_new_nll | 200 | 9.821012 | 9.670503 | 14.684742 | 20.918322 |
| llama3-8b-inst | rephrase | target_true_nll | 200 | 5.002349 | 4.228678 | 9.832077 | 18.113283 |
| llama3-8b-inst | locality | target_new_nll | 1000 | 10.879424 | 10.764357 | 15.898330 | 22.382336 |
| llama3-8b-inst | locality | target_true_nll | 1000 | 4.887518 | 4.297797 | 9.981033 | 20.467997 |
| llama3-8b-inst | locality | new_minus_true_nll_advantage | 1000 | 5.991906 | 6.035631 | 12.212558 | 20.331560 |
| qwen2.5-7b-inst | rewrite | target_new_nll | 100 | 10.371344 | 10.168028 | 15.470537 | 19.075062 |
| qwen2.5-7b-inst | rewrite | target_true_nll | 100 | 5.325203 | 4.949266 | 9.511560 | 14.071116 |
| qwen2.5-7b-inst | rephrase | target_new_nll | 200 | 10.019637 | 10.080389 | 14.681192 | 17.783127 |
| qwen2.5-7b-inst | rephrase | target_true_nll | 200 | 5.539293 | 4.700283 | 10.960173 | 16.584354 |
| qwen2.5-7b-inst | locality | target_new_nll | 1000 | 10.199011 | 10.061335 | 15.350891 | 22.165270 |
| qwen2.5-7b-inst | locality | target_true_nll | 1000 | 5.240019 | 4.563467 | 10.161244 | 21.817123 |
| qwen2.5-7b-inst | locality | new_minus_true_nll_advantage | 1000 | 4.958992 | 4.959952 | 11.235435 | 17.879733 |

locality `new-minus-true advantage`가 양수이면 target-true NLL이 더 낮아 canonical NS에 유리하다. 분포는 prompt 1,000개를 직접 집계했으며 request 평균으로 축소하지 않았다.

## 4. PRE_EDIT 대비 stock Official baseline 변화

| model | baseline | metric | PRE_EDIT | Official endpoint | delta |
| --- | --- | --- | --- | --- | --- |
| llama3-8b-inst | Official MEMIT | rewrite_success_rate | 13.00% | 98.00% | +85.00 pp |
| llama3-8b-inst | Official MEMIT | rephrase_success_rate | 14.00% | 82.00% | +68.00 pp |
| llama3-8b-inst | Official MEMIT | strict_rephrase_success_rate | 8.00% | 77.00% | +69.00 pp |
| llama3-8b-inst | Official AlphaEdit | rewrite_success_rate | 13.00% | 100.00% | +87.00 pp |
| llama3-8b-inst | Official AlphaEdit | rephrase_success_rate | 14.00% | 92.00% | +78.00 pp |
| llama3-8b-inst | Official AlphaEdit | strict_rephrase_success_rate | 8.00% | 89.00% | +81.00 pp |
| qwen2.5-7b-inst | Official MEMIT | rewrite_success_rate | 11.00% | 100.00% | +89.00 pp |
| qwen2.5-7b-inst | Official MEMIT | rephrase_success_rate | 19.50% | 96.00% | +76.50 pp |
| qwen2.5-7b-inst | Official MEMIT | strict_rephrase_success_rate | 10.00% | 95.00% | +85.00 pp |
| qwen2.5-7b-inst | Official AlphaEdit | rewrite_success_rate | 11.00% | 100.00% | +89.00 pp |
| qwen2.5-7b-inst | Official AlphaEdit | rephrase_success_rate | 19.50% | 95.50% | +76.00 pp |
| qwen2.5-7b-inst | Official AlphaEdit | strict_rephrase_success_rate | 10.00% | 94.00% | +84.00 pp |

NLL mean/median/p90/max까지 포함한 76-row 전체 차이는 `official-vs-preedit-deltas.csv`에 있다. endpoint canonical NS가 없으므로 NS delta는 만들지 않았다. PP는 W0와 endpoint 사이의 정의 자체라 별도 endpoint 사실값으로만 둔다.
...
아래 상세 본문은 v1 report SHA `54ef00e3944413a9908dd0ccabd33a487831c878b5a43bfbd55955ba03fa0a82`의 section 3–15를 계승한다. 원 파일명과 표 bytes는 v1 package에 있고, 본문에서 uppercase `NS`였던 prediction-preservation 명칭만 `PP`로 표시했다. canonical NS로 재해석하지 않는다.
...
### 6.3 동일 request의 Official O 대비 paired delta

delta는 `ours - O`다. NLL은 음수가 더 낮은 수치, target-new margin과 PP는 양수가 더 높은 수치다. equal은 tolerance를 만들지 않은 exact arithmetic equality다.
...
모든 target-new/target-true NLL, rewrite/rephrase margin, PP의 112개 paired summary는 `paired-official-deltas.csv`; QCL→NQFIX→ORBFH→JAC의 84개 predeclared adjacent contrast는 `method-contrast-deltas.csv`에 있다.

### 6.4 다섯 primary arm의 구현상 차이
...
### 6.5 Mechanism terminal 및 hit 사실
...
### 6.6 Layer별 terminal net update energy share (%)
...
### 6.8 Runtime B1 preamble와 integrity
...
### 6.9 기술 시도, B1 pilot, canonical B100 계보
...
### 6.10 ORBHit derived endpoint

| model | writer | status | factors | RS | PS | strict PS | PP |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| kind | absolute path | bytes | mode | sha256 |
| --- | --- | --- | --- | --- |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-0/manifest.json | 1006 | 0600 | 219245ab15abd8d9f407d21e435205c8aff918f100bbef1244d2be1a03a7dff3 |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-0/preedit-canonical-ns-prompt-pairs.jsonl.gz | 134477 | 0600 | 96b516820ece6e13f0c24ff6647cae9852eb6f950cef831815e91204ff7a288e |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-0/result.json | 4353 | 0600 | e72ff5ce0a27da5c70db38493412b926664ce552d36344e762b8717b316d8150 |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-0/rooted-receipt.json | 780 | 0600 | 176cae03f22488f8d5ce4f8b6033f6df00962ed1e01af21e5b3a9479b43529dd |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-1/manifest.json | 1007 | 0600 | 4338be9c422941fee7824a24c000087a5308afc4d67f379ad898e6ca4c0947d0 |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-1/preedit-canonical-ns-prompt-pairs.jsonl.gz | 134354 | 0600 | 71a2c450329715e5fb8ecd2533986afa2137a138b383cd8ee8a1719788a25a24 |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-1/result.json | 4343 | 0600 | 019078355d4bb1cd23fb3089f52b11a80d021dd88338d55f70c0ccbcb58a4984 |
| preedit_ns_backfill | /mnt/raid5/janghj/.codex/worktrees/odeeditsh1-s06-orbode-round0-analysis-v1/local/results/ordered-response-barrier-ode-round0-preedit-canonical-ns-tech-r2/task-1/rooted-receipt.json | 781 | 0600 | dcd597c54bced89417b6527f723ab28577948b7f3fd249cbb876394a3cb6441c |
