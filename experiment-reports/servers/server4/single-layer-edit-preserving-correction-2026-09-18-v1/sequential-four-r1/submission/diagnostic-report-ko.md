# ENFC 네 정책 sequential — submission

상태: `S4_REGISTERED_RUNNING_AWAITING_INITIAL`. 관측시각 2026-09-18T06:04:44.160928+00:00.
...
| job | 정책 | 범위 |
| --- | --- | --- |
| 50071_0 | EN-S | W0/zeroM4 → B100×10 |
| 50071_1 | EN-F | W0/zeroM4 → B100×10 |
| 50071_2 | EN-COV | W0/zeroM4 → B100×10 |
| 50071_3 | EN-F4 | W0/zeroM4 → B100×10 |
...
held owner/source/args/resource inspection을 통과한 뒤 2026-09-18T06:01:07.904716+00:00 release했다.
R/L 및 다른 S chain은 제출하지 않았다. 초기 actual 확인: NOT_OBSERVED.
...
Storage 관측free=157216272384bytes. 기존72GiB reserve waiver와 USER cleanup 예정 기록은 보존하며 cleanup 완료를 주장하지 않는다.
...
- 실행 HEAD `9e5884f5a2f8dcb7fc7406084f3fde94df450a55`, tree `aaacc6a0c55e19038a81516f40a9b4938c3fb38a`.
...
- 실행 root `/data/janghj/ODE-edit/local/single-layer-edit-preserving-correction/20260918-v1/S/attempt-v1`. 원 M source/lock/report는 불변이다.
- CPU receipt `/data/janghj/ODE-edit/local/single-layer-edit-preserving-correction/20260918-v1/S/preflight-r1/receipt.json`.
- 관측 receipt `/data/janghj/ODE-edit/local/single-layer-edit-preserving-correction/20260918-v1/S/receipts/observation-001.json`.
...
현재는 정상 제출 중간보고다. 실제 초기 경계만 bounded 확인하고 이후 모니터링을 중지한다.
