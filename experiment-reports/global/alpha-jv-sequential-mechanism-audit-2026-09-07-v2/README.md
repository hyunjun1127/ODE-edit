# GH 통합 분석·Sweep 보고서 안내

- 단일 통합 보고서: [gh-mechanism-review-ko.md](gh-mechanism-review-ko.md). 기전·모델별 결과 분석과 §13의 전체 10개 sweep 후보, 원본 compute-z 고정 정책을 함께 읽는다.
- 후보표와 정책의 기계 판독 부록: [CSV](sweep-candidates.csv), [JSON](sweep-candidate-policy.json). 본문 전체표와 동일함을 검증했다.
...
/mnt/raid5/janghj/EasyEdit/.venv/bin/python \
  experiment-reports/global/alpha-jv-sequential-mechanism-audit-2026-09-07-v2/analyze.py \
