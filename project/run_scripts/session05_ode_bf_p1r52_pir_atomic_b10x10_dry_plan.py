#!/usr/bin/env python3
"""Raw-free three-cell P1R52-PIR Atomic production dry plan."""
...
from project.run_scripts.ode_bf.p1r52_pir_panel import POLICIES
...
def build_plan(
    ...
    if len(source_head) != 40:
        raise ODEBFContractError("P1R52-PIR dry-plan source identity differs")
    jobs = [
        {
            "array_index": index,
            ...
            "method": {
                "pir-j0": "P1R52-PIR-J0",
                "pir-g": "P1R52-PIR-PIR-G",
                "pir-u": "P1R52-PIR-PIR-U",
            }[policy],
    ...
    return {
        "schema": "ode-edit-s05-p1r52-pir-atomic-dry-plan/v1",
