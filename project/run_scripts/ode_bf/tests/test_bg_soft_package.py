...
class BgSoftPackageTests(unittest.TestCase):
    ...
    def test_bundle_uses_advertised_head_and_exact_repair_chain(self) -> None:
        ...
        self.assertIn("BG_SOFT_RUNTIME_TECH_REPAIR_PARENT", validate_source)
        ...
        outputs = {
            ...
            ("git", "rev-parse", "HEAD^"): (
                package.BG_SOFT_RUNTIME_TECH_REPAIR_PARENT + "\n"
            ),
            ("git", "rev-parse", "HEAD^^"): (
    ...
    def test_submit_and_sbatch_fail_closed_on_exact_child_chain(self) -> None:
        ...
        self.assertIn("BG_SOFT_RUNTIME_TECH_REPAIR_PARENT", provenance_source)
        ...
        self.assertIn(
            'EXPECTED_RUNTIME_TECH_REPAIR_PARENT="'
            + package.BG_SOFT_RUNTIME_TECH_REPAIR_PARENT
            + '"',
            sbatch,
        )
    ...
    def test_operational_bundle_empty_bare_proof_and_thin_negative(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with (
                ...
                mock.patch.object(
                    package, "BG_SOFT_PACKAGE_REPAIR_PARENT", commits[2]
                ),
                mock.patch.object(
                    package, "BG_SOFT_EXECUTION_REPAIR_PARENT", commits[3]
                ),
                mock.patch.object(
                    package, "BG_SOFT_IMPLEMENTATION_PARENT", commits[4]
                ),
                mock.patch.object(package, "BG_SOFT_PARENT_HEAD", commits[5]),
            ):
