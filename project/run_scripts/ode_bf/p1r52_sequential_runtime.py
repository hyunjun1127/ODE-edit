...
def expected_p1r52_sequential_result_name(
    ...
    *,
    ...
    if role in (JOINT_PC_PILOT_ROLE, JOINT_PC_PILOT_TECH_R1_ROLE, JOINT_PC_PILOT_TECH_R2_ROLE, JOINT_PC_PILOT_TECH_R3_ROLE, JOINT_PC_PILOT_TECH_R4_ROLE, JOINT_PC_PILOT_TECH_R5_ROLE) or role.startswith(JOINT_PC_PRODUCTION_ROLE_PREFIX):
        if (
