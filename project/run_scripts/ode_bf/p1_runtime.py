...
def run_p1(
    *,
    ...
    p1r39_independent_b10x10_method: str | None = None,
    ...
    p2r2_attempt_suffix: str | None = None,
    p2r7_phase: str | None = None,
    p2r7_attempt_suffix: str | None = None,
    debt_priority_role: str | None = None,
    debt_priority_technical_attempt: str = "",
    p1r37_independent_b10x10_method: str | None = None,
    ...
    if sum(
        (
            ...
            p1r37_independent_b10x10_method is not None,
            p1r38_independent_b10x10_method is not None,
            p1r40_independent_b10x10_method is not None,
    ...
    if p2r4_phaseb_case_count is not None:
        from .p2r4_phaseb_atomic_runtime import expected_p2r4_phaseb_result_name

        if p2r4_phaseb_clamp_policy is None:
            raise ODEBFContractError("P2R4 Phase-B clamp policy is absent")
        expected_name = expected_p2r4_phaseb_result_name(
            alias,
            clamp_policy=p2r4_phaseb_clamp_policy,
            case_count=p2r4_phaseb_case_count,
            attempt_suffix=p2r4_phaseb_attempt_suffix,
        )
    elif debt_priority_role is not None:
    ...
    elif p1r52_residual_reserve_phase_a_arm is not None:
        ...
        expected_name = expected_p1r51_result_name(
            alias,
            phase=p1r51_phase,
            attempt_suffix=p1r51_attempt_suffix,
        )
    elif p2r7_phase is not None:
        from .p2r7_atomic_runtime import expected_p2r7_result_name

        expected_name = expected_p2r7_result_name(
            alias,
            phase=p2r7_phase,
            attempt_suffix=p2r7_attempt_suffix,
        )
    elif p2r2_case_count is not None:
        from .p2r2_atomic_runtime import expected_p2r2_result_name

        expected_name = expected_p2r2_result_name(
            alias,
            case_count=p2r2_case_count,
            attempt_suffix=p2r2_attempt_suffix,
        )
    elif p2r1_target_only_case_count is not None:
        from .p2r1_target_only_runtime import expected_p2r1_target_result_name

        expected_name = expected_p2r1_target_result_name(
            alias,
            case_count=p2r1_target_only_case_count,
            attempt_suffix=p2r1_attempt_suffix,
        )
        ...
        expected_name = expected_p1r42_independent_result_name(
            alias,
            p1r42_independent_b10x10_method,
            attempt_suffix=p1r42_attempt_suffix,
        )
    elif p1r39_independent_b10x10_method is not None:
        from .p1r39_independent_b10x10_runtime import (
            expected_p1r39_independent_result_name,
        )

        expected_name = expected_p1r39_independent_result_name(
            alias,
            p1r39_independent_b10x10_method,
            attempt_suffix=p1r39_attempt_suffix,
        )
    elif p1r40_independent_b10x10_method is not None:
        from .p1r40_independent_b10x10_runtime import (
            expected_p1r40_independent_result_name,
        )
    ...
    elif p1r37_independent_b10x10_method is not None:
        from .p1r37_independent_b10x10_runtime import (
            expected_p1r37_independent_result_name,
        )

        expected_name = expected_p1r37_independent_result_name(
            alias, p1r37_independent_b10x10_method
        )
        ...
        expected_name = expected_p1r36_independent_result_name(
            alias, p1r36_independent_b10x10_method
        )
    ...
    artifact_guard = ODEBFArtifactGuard(
        ...
        and p1r37_independent_b10x10_method is None
        # P2R7 is the same independent Atomic artifact class as P2R2.
        and p1r40_independent_b10x10_method is None
    ...
    if (
        ...
        or p1r37_independent_b10x10_method is not None
        or p1r40_independent_b10x10_method is not None
        ...
        if (
            ...
            if p2r4_phaseb_case_count is not None:
                from .p2r4_phaseb_atomic_panel import (
                ...
                from .p2r7_atomic_panel import (
                    LOCK_FILE as INDEPENDENT_LOCK_FILE,
                    load_and_validate_lock as load_and_validate_independent_lock,
                )
            elif p2r2_case_count is not None:
                from .p2r2_atomic_panel import (
                    LOCK_FILE as INDEPENDENT_LOCK_FILE,
                    load_and_validate_lock as load_and_validate_independent_lock,
                )
            elif p2r1_target_only_case_count is not None:
                from .p2r1_target_only_panel import (
                    LOCK_FILE as INDEPENDENT_LOCK_FILE,
                    load_and_validate_lock as load_and_validate_independent_lock,
                )
            elif p1r43_independent_b10x10_method is not None:
                ...
                from .p1r39_independent_b10x10_panel import (
                    LOCK_FILE as INDEPENDENT_LOCK_FILE,
                    load_and_validate_lock as load_and_validate_independent_lock,
                )
            elif p1r40_independent_b10x10_method is not None:
                from .p1r40_independent_b10x10_panel import (
                    LOCK_FILE as INDEPENDENT_LOCK_FILE,
                    load_and_validate_lock as load_and_validate_independent_lock,
                )
            elif p1r38_independent_b10x10_method is not None:
                ...
                from .p1r37_independent_b10x10_panel import (
                    LOCK_FILE as INDEPENDENT_LOCK_FILE,
                    load_and_validate_lock as load_and_validate_independent_lock,
                )
            else:
    ...
    if (
        ...
        if p2r7_phase is not None:
            from .p2r7_atomic_runtime import run_p2r7_atomic

            return run_p2r7_atomic(
                model,
                tokenizer,
                alias=alias,
                phase=p2r7_phase,
        ...
        if p2r2_case_count is not None:
            from .p2r2_atomic_runtime import run_p2r2_atomic

            return run_p2r2_atomic(
                model,
                tokenizer,
                alias=alias,
                destination=destination,
        ...
        if p2r1_target_only_case_count is not None:
            from .p2r1_target_only_runtime import run_p2r1_target_only

            return run_p2r1_target_only(
                model,
                tokenizer,
                alias=alias,
                destination=destination,
        ...
        if p1r42_independent_b10x10_method is not None:
            ...
            return run_p1r42_independent_b10x10(
                model,
                tokenizer,
                alias=alias,
                method=p1r42_independent_b10x10_method,
                destination=destination,
                raw_root=raw_root,
                stages=stages,
                source_head=source_head,
        ...
        if p1r39_independent_b10x10_method is not None:
            from .p1r39_independent_b10x10_runtime import (
                run_p1r39_independent_b10x10,
            )

            return run_p1r39_independent_b10x10(
                model,
                tokenizer,
                alias=alias,
                method=p1r39_independent_b10x10_method,
                destination=destination,
                raw_root=raw_root,
                stages=stages,
                source_head=source_head,
        ...
        if p1r40_independent_b10x10_method is not None:
            from .p1r40_independent_b10x10_runtime import (
                run_p1r40_independent_b10x10,
            )

            return run_p1r40_independent_b10x10(
                model,
                tokenizer,
                alias=alias,
                method=p1r40_independent_b10x10_method,
                destination=destination,
                raw_root=raw_root,
                stages=stages,
                source_head=source_head,
        ...
        if p1r37_independent_b10x10_method is not None:
            from .p1r37_independent_b10x10_runtime import (
                run_p1r37_independent_b10x10,
            )

            return run_p1r37_independent_b10x10(
                model,
                tokenizer,
                alias=alias,
                method=p1r37_independent_b10x10_method,
                destination=destination,
                raw_root=raw_root,
                stages=stages,
                source_head=source_head,
        ...
        if p1r36_independent_b10x10_method is not None:
            ...
            return run_p1r36_independent_b10x10(
                model,
                tokenizer,
                alias=alias,
                method=p1r36_independent_b10x10_method,
                destination=destination,
                raw_root=raw_root,
                stages=stages,
                source_head=source_head,
