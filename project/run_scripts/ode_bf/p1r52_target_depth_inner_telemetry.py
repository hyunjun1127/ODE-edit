...
def _metric(raw: Mapping[str, Any], name: str) -> Mapping[str, Any]:
    try:
        value = raw["primary"]["metrics"][name]
...
class P1R52TargetDepthTelemetryObserver:
    ...
    def __init__(
        ...
        *,
        ...
        if len(requests) != 10 or len(cases) != 10:
            raise ODEBFContractError("P1R52 inner telemetry requires one B10")
        self.model = model
    ...
    def _evaluate_z(
        ...
        with overlay:
            evaluated = evaluate_counterfact_stepwise_primary(
                self.model,
                self.tokenizer,
                self.cases,
    ...
    def observe_inner(
        ...
        *,
        ...
        payload: dict[str, Any] = {
            ...
            "pinned_numeric_vectors_sha256": str(raw["numeric_vectors_sha256"]),
    ...
    def observe_outer(
        ...
        *,
        ...
        w_primary = w_raw["primary"]
        z_primary = z_raw["primary"]
        panel: dict[str, Any] = {
        ...
        receipt: dict[str, Any] = {
            ...
            + int(z_primary["model_forward_count"]),
            "added_processed_token_count": int(w_primary["processed_token_count"])
            + int(z_primary["processed_token_count"]),
            "added_backward_count": 0,
            "added_generation_count": 0,
            "controller_action_influence_count": 0,
            "duplicate_evaluation_count": 0,
