...
P1R52_PIRU_SEQUENTIAL_REPAIR_REVISION = "TECH-R1"
P1R52_PIRU_SEQUENTIAL_ATTEMPT_SUFFIX = "pir-u-structuralh-on-tech-r1-v1"
P1R52_PIRU_SEQUENTIAL_RESULT_NAME = (
    "s05-p1r52-pir-u-soft-sequential-structuralh-on-10xb100-tech-r1-v1"
)
