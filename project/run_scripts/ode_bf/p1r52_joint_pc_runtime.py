...
PILOT_TECH_R5_ROLE = "r52-joint-pc-c1-c2-pilot-tech-r5"
PILOT_TECH_R6_ROLE = "r52-joint-pc-c1-c2-pilot-tech-r6"
...
PILOT_TECH_R5_RESULT_NAME = "s05-p1r52-joint-pc-c1-c2-pilot-b100-tech-r5-v1"
PILOT_TECH_R6_RESULT_NAME = "s05-p1r52-joint-pc-c1-c2-pilot-b100-tech-r6-v1"
...
def expected_result_name(role: str) -> str:
    ...
    if role == PILOT_TECH_R5_ROLE:
        return PILOT_TECH_R5_RESULT_NAME
    if role == PILOT_TECH_R6_ROLE:
        return PILOT_TECH_R6_RESULT_NAME
