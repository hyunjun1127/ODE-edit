...
def _run_ode_arm(
    ...
    *,
    ...
    if request_count not in (
        (1, 10, 100) if p1r52 else (1, 10) if p1r24 or p1r30 else (10, 100)
    ):
    ...
    arm_label = (
        ...
        if p1r34
        else f"{allocation}-P1R30-DEBT-PRIORITY-"
    ...
    try:
        for step_index in range(P1R23_GRID_COUNT):
            ...
            predicted = (
                ...
                else float(routing.selected_mean_progress)
                if p1r30
                else float(
                ...
                progress.update(
                    {
                        ...
                        / (
                            (
                                ...
                                if p1r30
                                else float(progress["alpha_apply"])
                            )
                            + STRENGTH_COVERAGE_EPSILON
                        ),
    ...
    *,
    ...
    if neutral_only or technical_smoke:
        terminal = {
            "schema": (
                ...
                if p1r34
                else "ode-edit-s05-p1r30-b1-smoke-terminal/v1"
                if p1r30
            ...
            "status": (
                ...
                if p1r34
                else "P1R30_B1_TECHNICAL_SMOKE_COMPLETE"
                if p1r30
        ...
        manifest = {
            "schema": (
                ...
                if p1r34
                else "ode-edit-s05-p1r30-b1-smoke-manifest/v1"
                if p1r30
    ...
    cases, freeze = _action_frozen_cases(
        ...
        arm=(
            ...
            if p1r34
            else f"P1R30-{allocation}-DEBT-PRIORITY-"
    ...
    return {
        "status": (
            ...
            if p1r34
            else "P1R30_B10_ATOMIC_COMPLETE"
            if p1r30
