            ...
            for model in MODELS:
                result = {
                    ...
                    "arms": [
                        ...
                        {"arm": "FZCB", "status": "SUBSPACE_INCONCLUSIVE", "denominator": {"valid_terminal": 0}, "A0": 1.0, "psi0": 0.1, "psi_min": 0.05, "g_free_norm_squared": 0.1, "evidence": {"sensitivity_method": "SKETCH"}},
