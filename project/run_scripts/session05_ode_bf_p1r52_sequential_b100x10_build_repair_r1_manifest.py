#!/usr/bin/env python3
"""Create-once source manifest for the B100 ordered-digest TECH-R1 repair."""
...
def main() -> int:
    ...
    value = {
        "schema_version": "ode-edit-s05-p1r52-sequential-b100x10-tech-r1-source-manifest/v1",
        "instruction_id": B100X10_INSTRUCTION_ID,
        "parent": PARENT,
        "parent_tree": PARENT_TREE,
        "supersedes_source_head": "99ee2629e9b944e917df653abb9b148bd838c647",
        "repair_revision": "TECH-R1",
        "repair_scope": "B100_EVALUATOR_ORDER_DIGEST_DISPATCH_ONLY",
        "repair_first_false_gate": "ORDERED_REQUEST_DIGEST_V1_REQUIRES_EXACT_B10",
    ...
    destination = LOCK_ROOT / SOURCE_MANIFEST
