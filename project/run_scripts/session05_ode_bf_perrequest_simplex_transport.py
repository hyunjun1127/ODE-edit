#!/usr/bin/env python3
"""Create-once P1R15 Stage-A single-arm entry point."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--run-token", required=True, choices=(P1R15_STAGE_A_RESULT_TOKEN,))
    ...
    try:
        ...
        if args.namespace_probe:
            print(
                json.dumps(
                    {
                        "status": "P1R15_STAGE_A_NAMESPACE_PASS_NO_MODEL",
            ...
            return 0
        result = run_p1r15_stage_a_experiment(
            repo_root=REPO_ROOT,
            alias=args.model,
            output_root=args.output_root,
            source_head=args.source_head,
        )
    except P1R15OutputRootCollision:
        return 1
    except Exception as exc:
        failure = {
            "schema": "ode-edit-s05-p1r15-stage-a-failure/v1",
            "status": "FAIL_CLOSED",
            "instruction_id": P1R15_INSTRUCTION_ID,
            "model_alias": args.model,
            "source_head": args.source_head,
