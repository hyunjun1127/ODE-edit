#!/usr/bin/env python3
"""Create-once TECH-R1 R52-only source manifest for accepted-z observation."""
...
SOURCE_PATHS = BASE_SOURCE_PATHS + (
    ...
    "project/run_scripts/session05_ode_bf_p1r52_b100_accepted_z_observation_build_tech_r1_r52_manifest.py",
    "project/run_scripts/session05_ode_bf_submit_p1r52_b100_accepted_z_observation_tech_r1_r52.py",
)
...
def main() -> int:
    ...
    value = {
        ...
        "repair_revision": "TECH-R1-R52",
        "repair_parent": "baa20e0ec05fdf6318af3a345af952c8f76ce8ee",
        "repair_scope": "INVALID_R52_CELLS_USING_IDENTICAL_FORMAT_FREE_SUBJECT_LAST_LOOKUP",
    ...
    destination = REPO_ROOT / "project/run_scripts/ode_bf/locks" / MANIFEST_TECH_R1_R52_FILE
