...
LOG_ROOT = REPO_ROOT / "local/odebf/logs/p1r22-atomic-runtime-conformance-tech-r3"
RESULT_PARENT = REPO_ROOT / "local/odebf/results"
NAMESPACE = "s05-atomic-runtime-optimization-p1r22-c0c1-sh2-array-tech-r3-v1"
...
def submit(source_head: str) -> dict[str, object]:
    ...
    result_names = tuple(
        f"s05-atomic-runtime-optimization-p1r22-c0c1-{job['alias']}-tech-r3-v1"
