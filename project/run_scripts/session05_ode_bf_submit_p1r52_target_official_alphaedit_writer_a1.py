...
from project.run_scripts.ode_bf.p1r52_target_official_alphaedit_writer import PHASE_A_RESULT_NAME
...
def submit(source_head: str) -> dict[str, object]:
    ...
    output_root = REPO_ROOT / "local/odebf/results" / PHASE_A_RESULT_NAME
    state_root = REPO_ROOT / "local/odebf/state/p1r52-target-official-alphaedit-writer-a1-v1"
    log_root = REPO_ROOT / "local/odebf/logs/p1r52-target-official-alphaedit-writer-a1-v1"
