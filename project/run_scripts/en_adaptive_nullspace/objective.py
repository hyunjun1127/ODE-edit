...
class Objective:
    def __init__(self, model, root, inputs):
        ...
        # No inherited T/FD waiver: large immutable teacher SHA evidence is
        # reused, with member stat bindings checked at this task's admission.
        self.store._receipt['validation_policy']='PRIOR_COMPLETED_PAYLOAD_SEAL_REUSE_NEW_T0_REQUIRED'
        self.store._receipt['fresh_payload_full_rehash']=False
