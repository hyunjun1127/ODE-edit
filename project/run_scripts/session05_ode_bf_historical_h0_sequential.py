#!/usr/bin/env python3
"""Fail-closed entry for one exact Progress-Simplex Sequential-NoH trajectory."""
...
RUN_TOKEN = "p1r23-progress-simplex-sequential-noh-v1"
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        failure_sha, failure = write_p1_failure_once(
            ...
            failure_schema="ode-edit-s05-p1r23-progress-simplex-sequential-noh-failure/v1",
        )
