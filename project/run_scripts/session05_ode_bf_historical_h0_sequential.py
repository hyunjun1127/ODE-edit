#!/usr/bin/env python3
"""Fail-closed entry point for one P1R20 sequential trajectory."""
...
RUN_TOKEN = "historical-h0-bg-sequential-p1r20-v1"
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        failure_sha, failure = write_p1_failure_once(
            ...
            failure_schema="ode-edit-s05-historical-h0-bg-sequential-p1r20-failure/v1",
        )
