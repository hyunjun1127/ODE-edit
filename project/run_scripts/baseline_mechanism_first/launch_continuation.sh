#!/usr/bin/env bash
#SBATCH --job-name=odeedit_e01_warm_l4_s1
...
exec /mnt/raid5/janghj/EasyEdit/.venv/bin/python -u -m project.run_scripts.baseline_mechanism_first.continuation --lock "$e01_lock" --output "$e01_output"
