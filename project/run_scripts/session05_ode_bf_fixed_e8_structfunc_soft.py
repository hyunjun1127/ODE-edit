#!/usr/bin/env python3
"""Fail-closed entry for the S05 fixed-E8 soft-routing diagnostic."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="session05-ode-bf-fixed-e8-structfunc-soft",
        allow_abbrev=False,
    )
    ...
    parser.add_argument(
        "--run-token", required=True, choices=(FIXED_E8_RESULT_TOKEN,)
    )
    return parser
