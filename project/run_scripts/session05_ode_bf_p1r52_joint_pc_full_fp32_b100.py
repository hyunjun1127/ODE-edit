#!/usr/bin/env python3
"""Fail-closed launcher for the full-FP32 one-B100 Joint-P/C panel."""
...
from project.run_scripts.ode_bf.p1r52_joint_pc_fp32_runtime import (
    INSTRUCTION_ID,
    RESULT_NAME,
    ROLE,
)
...
SOURCE_FILES = (
    ...
    "project/run_scripts/session05_ode_bf_p1r52_joint_pc_full_fp32_b100.py",
...
def source_manifest() -> dict[str, object]:
    ...
    payload: dict[str, object] = {
        "schema": "ode-edit-s05-p1r52-joint-pc-full-fp32-source-manifest/v1",
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if observed != args.source_head:
            raise ValueError("FP32 Joint-P/C source head differs")
        ...
        result.update({
            ...
            "expected_result_name": RESULT_NAME,
        ...
        failure_sha, failure = write_p1_failure_once(
            ...
            instruction_id=INSTRUCTION_ID,
            failure_schema="ode-edit-s05-p1r52-joint-pc-full-fp32-b100-failure/v1",
        )
