...
def build_plan(source_head: str, *, stage: str) -> dict[str, object]:
    roles = (
        ...
        else (PILOT_TECH_R5_ROLE,)
        if stage == "pilot-tech-r5"
        else (PILOT_TECH_R6_ROLE,)
        if stage == "pilot-tech-r6"
        ...
        "jobs": [
            {
                "array_index": index,
                "role": role,
                "case_index": 1 if role in (PILOT_ROLE, PILOT_TECH_R1_ROLE, PILOT_TECH_R2_ROLE, PILOT_TECH_R3_ROLE, PILOT_TECH_R4_ROLE, PILOT_TECH_R5_ROLE, PILOT_TECH_R6_ROLE) else index + 1,
...
def main() -> int:
    ...
    parser.add_argument("--stage", choices=("pilot", "pilot-tech-r1", "pilot-tech-r2", "pilot-tech-r3", "pilot-tech-r4", "pilot-tech-r5", "pilot-tech-r6", "production"), required=True)
