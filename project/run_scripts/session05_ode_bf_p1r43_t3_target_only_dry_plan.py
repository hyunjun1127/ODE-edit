#!/usr/bin/env python3
"""No-model dry plan for P1R43_T3 target-only Gate A."""
...
def build_plan(
    ...
    *,
    ...
    if (
        ...
        raise RuntimeError("P1R43_T3 dry-plan input differs")
    jobs = [
        {
            "array_index": index,
            "alias": alias,
            "method": "P1R43-T3-FIXED-W0-TARGET-HORIZON",
            "result_name": expected_p1r43_t3_target_result_name(
    ...
    return {
        "schema": "ode-edit-s05-p1r43-t3-fixed-w0-target-horizon-dry-plan/v1",
