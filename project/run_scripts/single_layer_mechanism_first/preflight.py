...
def build(repo, stage, attempt):
    ...
    lock.update(instruction=INSTRUCTION,authority_commit=AUTHORITY,stage=stage,
        ...
        prior_skip_or_storage_waiver_inherited=False,
        ...
        storage_plan=dict(B1_new_upper_GiB=24,CP_and_weights_GiB=8,
            derivative_factors_GiB=4,geometry_GiB=5,temporary_and_reports_GiB=7,
