...
def main() -> None:
    ...
    resolved_python = pytest_python.resolve(strict=True)
    if not pytest_python.is_file() or not resolved_python.is_file():
    ...
    payload = {
        ...
        "pytest_python_resolved": str(resolved_python),
