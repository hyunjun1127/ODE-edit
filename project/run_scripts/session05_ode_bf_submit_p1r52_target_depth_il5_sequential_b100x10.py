...
def submit(source_head: str) -> dict[str, object]:
    ...
    state_root = REPO_ROOT / "local/odebf/state/p1r52-il5-sequential-10xb100-tech-r3-v1"
    log_root = REPO_ROOT / "local/odebf/logs/p1r52-il5-sequential-10xb100-tech-r3-v1"
    ...
    namespace = f"p1r52-il5-sequential-tech-r3-{source_head[:12]}-v1"
    ...
    receipt = {
        ...
        "superseded_scheduler_job_id": "22161",
