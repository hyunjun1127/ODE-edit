#!/usr/bin/env python3
"""Held-inspect-release submitter for P1R24 smoke/production arrays."""
...
from project.run_scripts import session05_ode_bf_p1r24_atomic_strength_dry_plan as dry
from project.run_scripts.ode_bf.contracts import ODEBFContractError


SBATCH = REPO_ROOT / "project/run_scripts/session05_ode_bf_p1r24_atomic_strength.sbatch"
...
def submit(source_head: str, phase: str) -> dict[str, object]:
    ...
    submitted = _run([
        ...
        "--job-name", f"odeedit_s05_p1r24_{phase}",
    ...
    if not job_id.isdigit():
        raise ODEBFContractError("P1R24 scheduler ID differs")
    ...
    if not all(item in observed for item in required):
        ...
        raise ODEBFContractError("P1R24 held scheduler contract differs")
    receipt = {
        "schema": "ode-edit-s05-p1r24-submission/v1",
        "source_head": source_head,
        "phase": phase,
        "job_id": job_id,
        "array": array,
