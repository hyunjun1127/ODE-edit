# P1R52 Sequential H-ON / H-OFF / corrected AlphaEdit / MEMIT — canonical four-arm factual v5

> 사용자 명시적 overwrite 승인에 따라 legacy three-arm filename을 유지하면서 cache-reset Native를 superseded appendix로 내리고, official AlphaEdit cache_c ON과 official MEMIT을 동일 stream/evaluator로 직접 통합했습니다.
