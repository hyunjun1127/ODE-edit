...
| SH2 / server2 | `019fc5ec-f85b-7770-a73a-1d19be1cd491` | `019fe491-954b-70a0-8ba8-0588e9f8d741` | direct ACK; repo/context confirmed; local boundary provisioning pending; execution HOLD |
...
- blocker: current root의 local-only `agent.*`와
  `servers/local/session-boundary.env` provisioning 미완료
- authority: registration ACK only; source/model/GPU/Slurm/push/merge/rsync HOLD
...
확인했다. SH2는 local provisioning 완료와 checker PASS 전까지 실행하지 않는다.
