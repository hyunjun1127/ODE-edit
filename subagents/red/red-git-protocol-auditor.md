...
- 대용량 파일 전송이 `transfers/requests/`, `transfers/approvals/`,
  `transfers/verifications/` 흐름을 따르는가
- 사용자 승인 없이 반복 `rsync` 또는 열린 범위의 전송이 실행되지 않는가
- 대여 서버 onboarding/offboarding checklist가 완료되었는가
